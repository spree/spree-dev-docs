...
An adjustment to an order from a promotion depends on the calculators. For more information about calculators, please see the [Calculators guide](https://dev-docs.spreecommerce.org/internals/calculators).
