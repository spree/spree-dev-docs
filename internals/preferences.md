...
Extensions can also define site-wide preferences. For more information on using preferences like this with extensions, check out the [Extensions Tutorial](https://dev-docs.spreecommerce.org/extensions/extensions).
